...
<table>
  <tr>
    <td width="50%">
      ...
      <ul>
        <li>47,714 UBS records analyzed</li>
        <li>27 Brazilian states represented</li>
        <li>5,483 municipalities identified</li>
        <li>45,785 records with valid coordinates</li>
      </ul>
    ...
    <td width="50%">
      ...
      <p>Machine learning project using 918 patient records and 11 clinical predictors to evaluate heart disease classification models and discuss clinical limitations.</p>
      <ul>
        <li>918 clinical records analyzed</li>
        <li>Logistic Regression and Random Forest tested</li>
        <li>ROC-AUC around 0.93</li>
        <li>Ethical and clinical limitations documented</li>
      </ul>
...
Some of my applied work cannot be publicly shared because it involves institutional or private company data. I present these projects only through anonymized descriptions and transferable skills.

| Project | Context | Skills demonstrated |
|---|---|---|
| **Clinical Pharmacy KPI Dashboard** | Confidential project — EBSERH / HC-UFU | KPI design, hospital workflow analysis, operational monitoring, decision support |
| **AI for Scientific Communication in Healthcare** | Confidential projects — private healthcare companies | Applied AI, automation, health communication, content strategy, low-code workflows |
...
- Professional experience across healthcare operations, pharmaceutical business projects, technical support and health data analysis
