...
class TelemedicineOutputAuditTests(unittest.TestCase):
    def test_outputs_keep_national_and_pharmacy_pilot_views_separated(self):
        ...
        self.assertEqual(summary["phase5_evidence_grade_counts"]["A_intramunicipal_population_weighted"], 5570)
        self.assertEqual(summary["phase5_evidence_grade_counts"]["B2_municipal_population_proxy"], 1)
